				...
				m = (
						...
						O =
							...
							((e) => {
								...
								if (
									o(y) &&
									((t.has(e) && r.get(e) !== y.n) ||
										Array.from(y.d).every(([e, t]) => O(e).n === t))
								)
									return y;
								y.d.clear();
								let _ = !0,
								...
								try {
									...
									return delete y.v, (y.e = e), ++y.n, y;
								} finally {
									(_ = !1),
										E !== y.n &&
											r.get(e) === E &&
											(r.set(e, y.n), u.add(e), null == (s = p.c) || s.call(p, e));
								}
							}),
						T =
							k[4] ||
						...
						M =
							...
							((e) => {
								...
								let n = S(e),
									l = t.get(e);
								if (!l) {
									for (let t of (O(e), n.d.keys())) M(t).t.add(e);
					...
					return (
						Object.defineProperty(D, y, {
							value: [e, t, r, u, s, g, p, m, _, b, E, S, x, A, O, T, W, j, M, z],
						}),
						D
					);
				},
						...
						return function (r) {
							...
							for (let u in t) {
								...
								if (
									...
									o[u] = d._;
									let e = Object.keys(d).filter((e) => '_' !== e),
										t = e.filter((e) => e.startsWith('<') || e.endsWith('>')),
										r = e.filter((e) => e.includes(':')),
									...
									for (let e of r) {
										...
										let o = n[t],
											s = n[r];
										if (!o || !s) continue;
										let f = l(o, null, void 0 !== s[1] ? s[1] : s[0]);
										f && (a[2][f] || (a[2][f] = {}), (a[2][f][u] = d[e]));
									}
									for (let e of s) {
										let t = n[e];
										if (!t) continue;
										let r = l(t);
										r && (a[3][r] || (a[3][r] = {}), (a[3][r][u] = d[e]));
									}
								} else if (d && 'object' == typeof d && !Array.isArray(d)) {
									let t = e(d)(r);
									for (let e in t)
										e.startsWith('@media')
											? (a[3][e] || (a[3][e] = {}),
												a[3][e][u] || (a[3][e][u] = {}),
												Object.assign(a[3][e][u], t[e]))
											: (o[u] || (o[u] = {}), (o[u][e] = t[e]));
								} else o[u] = d;
							}
							let u = {};
							for (let e of [1, 2, 3])
								for (let t in a[e]) u[t] || (u[t] = {}), Object.assign(u[t], a[e][t]);
							return { ...o, ...u };
						};
					},
			});
