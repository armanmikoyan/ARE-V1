	...
	[792],
	{
		...
		692: (e, t, r) => {
			...
			function p(e) {
				...
				return (0, a.jsx)(i.PathnameContext.Provider, { value: s, children: t });
			}
		},
		795: (e, t, r) => {
			'use strict';
		...
		866: (e, t, r) => {
			...
			let n = r(3563);
			function a(e) {
				return (0, n.pathHasPrefix)(e, '/ARE-V1');
			}
			('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
				void 0 === t.default.__esModule &&
				(Object.defineProperty(t.default, '__esModule', { value: !0 }),
			...
			function s(e, t, r, s, c, f) {
				let d,
					...
					m = (0, o.removeTrailingSlash)(
						(0, i.normalizeLocalePath)((0, u.removeBasePath)(_.pathname), f).pathname,
					),
					g = (r) => {
						let l = (0, n.getPathMatch)(r.source + '', { removeUnnamedParams: !0, strict: !0 })(
							_.pathname,
						);
						...
						if (l) {
							...
							if (
								...
								(m = (0, o.removeTrailingSlash)(
									(0, i.normalizeLocalePath)((0, u.removeBasePath)(e), f).pathname,
								)),
								t.includes(m))
							)
								return (p = !0), (d = m), !0;
				...
				return { asPath: e, parsedAs: _, matchedPage: p, resolvedHref: d, externalDest: h };
			}
		},
		1291: () => {
						...
						children: [
							...
							(0, a.jsxs)('div', {
								...
								children: [
									...
									e
										? (0, a.jsx)('h1', { className: 'next-error-h1', style: s.h1, children: e })
										: null,
									(0, a.jsx)('div', {
										style: s.wrap,
		...
		4929: (e, t, r) => {
							...
							if (u.startsWith('/')) {
								...
								return Promise.all([
									...
									if (
										...
										t.pathname = u = (0, R.addBasePath)(r.pathname);
									}
									{
										let e = (0, _.default)(u, o, i, t.query, (e) => B(e, o), r.router.locales);
										e.matchedPage &&
									...
									if ((0, p.isDynamicRoute)(f)) {
										let e = (0, m.getRouteMatcher)((0, g.getRouteRegex)(f))(u);
			...
			class Y {
				...
				async _bfl(e, t, n, a) {
					{
						if (!this._bfl_s && !this._bfl_d) {
							...
							(null == t ? void 0 : t.numHashes) &&
								...
								(null == o ? void 0 : o.numHashes) &&
									((this._bfl_d = new u(o.numItems, o.errorRate)), this._bfl_d.import(o));
						}
						let c = !1,
							f = !1;
						for (let { as: r, allowMatchCurrent: i } of [{ as: e }, { as: t }])
							if (r) {
								...
								if (
									i ||
									t !== (0, o.removeTrailingSlash)(new URL(this.asPath, 'http://n').pathname)
								) {
									var u, l, s;
									for (let e of ((c =
										c ||
				...
				async change(e, t, r, n, a) {
					var s, c, f, S, T, j, A, w, M;
					let L, U;
					if (!(0, C.isLocalURL)(t)) return V({ url: t, router: this }), !1;
					let H = 1 === n._h;
					...
					this._inFlightRoute &&
						this.clc &&
						(z || Y.events.emit('routeChangeError', D(), this._inFlightRoute, J),
						this.clc(),
						(this.clc = null)),
						(r = (0, R.addBasePath)(
							(0, b.addLocale)(
					...
					if (!H && this.onlyAHashChange(Z) && !ee) {
						...
						try {
							...
							throw (
								((0, l.default)(e) && e.cancelled && Y.events.emit('routeChangeError', e, Z, J), e)
							);
						}
					...
					try {
						[L, { __rewrites: U }] = await Promise.all([
					...
					let eu = !!(
							ei &&
							eo !== ei &&
							(!(0, p.isDynamicRoute)(eo) || !(0, m.getRouteMatcher)((0, g.getRouteRegex)(eo))(ei))
						),
						el = !n.shallow && (await k({ asPath: r, locale: q.locale, router: this }));
					if ((H && el && (W = !1), W && '/_error' !== er))
						if (((n._shouldResolveHref = !0), r.startsWith('/'))) {
							let e = (0, _.default)(
								(0, R.addBasePath)((0, b.addLocale)(Z, q.locale), !0),
								L,
								U,
								en,
								(e) => B(e, L),
							...
							(et.pathname = B(er, L)),
								et.pathname !== er &&
									...
									(et.pathname = (0, R.addBasePath)(er)),
									el || (t = (0, y.formatWithValidation)(et)));
					if (!(0, C.isLocalURL)(r)) return V({ url: r, router: this }), !1;
					(ea = (0, P.removeLocale)((0, v.removeBasePath)(ea), q.locale)),
						...
						if (es && (!o || i.result))
							o
								? (r = (0, y.formatWithValidation)(
										Object.assign({}, e, { pathname: i.result, query: (0, I.omit)(en, i.params) }),
									))
								: Object.assign(en, es);
						else {
					...
					try {
						...
						if (
							(H ||
								n.shallow ||
								(await this._bfl(r, 'resolvedAs' in o ? o.resolvedAs : void 0, q.locale)),
							'route' in o && el)
						) {
						...
						if ('type' in o)
							...
							else return V({ url: o.destination, router: this }), new Promise(() => {});
						let i = o.Component;
						if (
							(i &&
							...
							if (((q.isPreview = !!o.props.__N_PREVIEW), o.props.notFound === X)) {
								let e;
								try {
						...
						let s = n.shallow && q.route === (null != (T = o.route) ? T : eo),
							d = null != (j = n.scroll) ? j : !H && !s,
							_ = null != a ? a : d ? { x: 0, y: 0 } : null,
							y = { ...q, route: eo, pathname: er, query: en, asPath: Z, isFallback: !1 };
						if (H && ec) {
							if (
								((o = await this.getRouteInfo({
									route: this.pathname,
							...
							'/_error' === this.pathname &&
								(null == (w = self.__NEXT_DATA__.props) || null == (A = w.pageProps)
									? void 0
									: A.statusCode) === 500 &&
							...
							try {
								...
								throw (
									((0, l.default)(e) && e.cancelled && Y.events.emit('routeChangeError', e, Z, J),
									e)
								);
							}
							return !0;
						...
						if (
							...
							!(H && !_ && !G && !ee && (0, x.compareRouterStates)(y, this.state)))
						) {
							try {
								await this.set(y, o, _);
							} catch (e) {
							...
							if (o.error) throw (H || Y.events.emit('routeChangeError', o.error, Z, J), o.error);
				...
				async handleRouteInfoError(e, t, r, n, a, o) {
					...
					if ((0, i.isAssetError)(e) || o)
						throw (Y.events.emit('routeChangeError', e, n, a), V({ url: n, router: this }), D());
					console.error(e);
					try {
						let n,
							{ page: a, styleSheets: o } = await this.fetchComponent('/_error'),
							i = { props: n, Component: a, styleSheets: o, err: e, error: e };
						if (!i.props)
							try {
								i.props = await this.getInitialProps(a, { err: e, pathname: t, query: r });
							} catch (e) {
				...
				async getRouteInfo(e) {
					...
					try {
						...
						if (
							...
							h &&
								(S
									...
									: (S = { json: self.__NEXT_DATA__.props })),
							t(),
							(null == S || null == (E = S.effect) ? void 0 : E.type) === 'redirect-internal' ||
								(null == S || null == (b = S.effect) ? void 0 : b.type) === 'redirect-external')
						)
							return S.effect;
						if ((null == S || null == (P = S.effect) ? void 0 : P.type) === 'rewrite') {
							...
							if (
								...
								(i = (0, v.removeBasePath)(
									(0, c.normalizeLocalePath)(S.effect.parsedAs.pathname, this.locales).pathname,
								)),
								(e = this.components[g]),
						...
						if ((0, T.isAPIRoute)(g)) return V({ url: a, router: this }), new Promise(() => {});
						let j =
								l ||
							...
							A =
								null == S || null == (R = S.response) ? void 0 : R.headers.get('x-middleware-skip'),
						...
						return (
							j.__N_SSP && O.dataHref && w && delete this.sdc[w],
							this.isPreview ||
								!j.__N_SSG ||
								h ||
								q(
				...
				async prefetch(e, t, r) {
					...
					if (t.startsWith('/')) {
						...
						O || (f = (0, P.removeLocale)((0, v.removeBasePath)(a.asPath), this.locale)),
							a.matchedPage &&
								a.resolvedHref &&
								((n.pathname = u = a.resolvedHref), O || (e = (0, y.formatWithValidation)(n)));
					}
					(n.pathname = B(n.pathname, c)),
				...
				constructor(
					...
					(this.sdc = {}),
						...
						(this.onPopState = (e) => {
							...
							if (!n) {
								...
								this.changeState(
									'replaceState',
									(0, y.formatWithValidation)({ pathname: (0, R.addBasePath)(e), query: t }),
									(0, d.getURL)(),
								);
								return;
							}
					...
					if (
						...
						let n = { locale: _ },
							a = (0, d.getURL)();
						this._initialMatchesMiddlewarePromise = k({ router: this, locale: _, asPath: a }).then(
							(o) => (
			...
			(() => {
				...
				(() => {
					(t.parse = function (t, r) {
						...
						for (var a = {}, o = t.split(n), i = (r || {}).decode || e, u = 0; u < o.length; u++) {
							var l = o[u],
								s = l.indexOf('=');
							if (!(s < 0)) {
		...
		6656: (e, t, r) => {
			...
			class G extends y.default.Component {
				...
				componentDidMount() {
					this.scrollToHash(),
						n.isSsr &&
							(a.isFallback ||
								(a.nextExport && ((0, O.isDynamicRoute)(n.pathname) || location.search || 1)) ||
			...
			async function V(e) {
				...
				if (
					...
					(0, T.setConfig)({ serverRuntimeConfig: {}, publicRuntimeConfig: a.runtimeConfig || {} }),
					(o = (0, j.getURL)()),
						...
						.then((r) => {
							...
							let { ErrorComponent: l, styleSheets: s } = r,
								...
								f = {
									...
									AppTree: c,
									router: n,
									ctx: { err: u, pathname: a.page, query: a.query, asPath: o, AppTree: c },
								};
							return Promise.resolve(
			...
			function ei(e) {
				...
				return (
					ee
						...
						: ((ee = E.default.hydrateRoot(b, P, { onRecoverableError: B.onRecoverableError })),
							(et = !1)),
					h
				);
			}
			...
			async function el(e) {
				...
				let r = { App: f, initial: !0, Component: p, props: a.props, err: t, isHydratePass: !0 };
		...
		6886: (e, t) => {
			...
			function o(e, t) {
				for (let [o, i] of Object.entries(t)) {
					...
					'SCRIPT' === e.tagName && a(u) ? (e[u] = !!i) : e.setAttribute(u, String(i)),
						(!1 === i || ('SCRIPT' === e.tagName && a(u) && (!i || 'false' === i))) &&
		...
		7469: (e, t, r) => {
			...
			let n = r(5214),
				a = r(7810);
			function o(e, t) {
				return (0, a.normalizePathTrailingSlash)((0, n.addPathPrefix)(e, '/ARE-V1'));
			}
			('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
				void 0 === t.default.__esModule &&
				(Object.defineProperty(t.default, '__esModule', { value: !0 }),
		...
		8380: (e, t, r) => {
			...
			function f(e) {
				...
				u && (u = l(u));
				let s = r.hash;
				return s && (s = l(s)), { ...r, pathname: n, hostname: u, href: i, hash: s };
			}
			function d(e) {
				let t,
					r,
				...
				if (u) {
					let e = [];
					for (let t of ((0, n.pathToRegexp)(u, e), e)) p.push(t.name);
				}
				let _ = (0, n.compile)(d, { validate: !1 });
				for (let [r, a] of (u && (t = (0, n.compile)(u, { validate: !1 })), Object.entries(s)))
					Array.isArray(a)
						? (s[r] = a.map((t) => c(l(t), e.params)))
						: 'string' == typeof a && (s[r] = c(l(a), e.params));
				let m = Object.keys(e.params).filter((e) => 'nextInternalLocale' !== e);
				if (e.appendParamsToQuery && !m.some((e) => p.includes(e)))
					for (let t of m) t in s || (s[t] = e.params[t]);
				...
				return (o.query = { ...a, ...o.query }), { newUrl: r, destQuery: s, parsedDestination: o };
			}
		},
		8400: (e, t) => {
			'use strict';
					...
					let r = (function (e) {
						...
						return (
							i
								...
								: o &&
									(n.textContent = 'string' == typeof o ? o : Array.isArray(o) ? o.join('') : ''),
							n
						);
					})(t[e]);
									...
									if ((t && t.push(_), m || g))
										if ('+' === _.modifier || '*' === _.modifier) {
											...
											p +=
												...
												')' +
												y;
										} else p += '(?:' + m + '(' + _.pattern + ')' + g + ')' + _.modifier;
									else p += '(' + _.pattern + ')' + _.modifier;
								else p += '(?:' + m + g + ')' + _.modifier;
							}
						}
						if (void 0 === l || l) i || (p += d + '?'), (p += r.endsWith ? '(?=' + f + ')' : '$');
						else {
							var E = e[e.length - 1],
								b = 'string' == typeof E ? d.indexOf(E[E.length - 1]) > -1 : void 0 === E;
							i || (p += '(?:' + d + '(?=' + f + '))?'), b || (p += '(?=' + d + '|' + f + ')');
						}
